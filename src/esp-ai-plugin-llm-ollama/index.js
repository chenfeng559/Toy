...
module.exports = {
     ...
     *  
    */
    async main({ device_id, devLog, api_key, text, llmServerErrorCb, llm_init_messages = [], llm_historys = [], cb, llm_params_set, logWSServer }) {
        ...
        */
        ...
        for await (const part of response) {
            ...
            const isDone = part.done;
            devLog && console.log('LLM 输出 ：', content);
            texts["count_text"] += content;
            cb({ text, texts, is_over: isDone })
        }
